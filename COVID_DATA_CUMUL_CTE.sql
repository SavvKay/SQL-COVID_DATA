WITH c1 AS (SELECT
	...
	, cd.NEW_DEATHS 
	, SUM(cd.NEW_DEATHS) OVER (PARTITION BY cd.LOCATION ORDER BY cd.LOCATION, cd.RECORD_DATE) AS FATALITIES_ROLLING_SUM
...
, (c1.FATALITIES_ROLLING_SUM/c1.POP)*100 AS FATALITIES_TO_POP
, (c1.FATALITIES_ROLLING_SUM/c1.CASES_ROLLING_SUM)*100 AS FATALITIES_TO_CASES
